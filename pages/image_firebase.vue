...
export default {
    ...
    methods: {
        ...
        upload() { // this function is to upload an image to firebase storage
            const storage = getStorage();
            const httpsReference = ref(storage, `post/test.png`);
